...
public:
    ...
    GageDrone(std::string name, point start, point end);

    /// <summary>
    /// Constructor for the GageDrone class.
    /// Use this when you instantiate new drones.
    /// This one assumes that you want your end and start to have 
    /// same xy location but it will have end height of STANDARD_HEIGHT.
    /// <para>...</para>
    /// Author: Malachi Sanderson
    /// <para>...</para>
    /// Made: 11-28-22
    ...
    /// <param name="name"></param>
    /// <param name="start"></param>
    GageDrone(std::string name, point start);

    /// <summary>
    /// Constructor for the GageDrone class.
    /// Use this when you instantiate new drones.
    /// This one assumes that you want your end and start to have
    /// same xy location but it will let you specify end height.
    /// <para>...</para>
    /// Author: Malachi Sanderson
    /// <para>...</para>
    /// Made: 11-28-22
    ...
    GageDrone(std::string name, point start, float height);

    //DO NOT CALL THIS!!!! This just exists to get around some compiliation errors.
    GageDrone(){};
